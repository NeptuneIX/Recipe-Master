...
export class AppService {
  ...
  getRecipeList() {
   ...
   this.httpClient.get<{message: string, recipes: any}>(this.baseUrl + 'getRecipes/' + this.curPage).subscribe(result => {
  ...
  getSavedRecipeList() {
   this.httpClient.get<{message: string, recipes: any}>(this.baseUrl + 'getSavedRecipes/' + this.curPage, { withCredentials: true }).subscribe(result => {
  ...
  getRecipe(recipeDataId: string) {
    ...
    this.httpClient.get<{message: string, recipe: any}>(this.baseUrl + 'getRecipe/' + recipeDataId).subscribe(result => {
  ...
  searchRecipes(recipeName: string) {
    this.httpClient.get<{message: string, searchResults: any}>(this.baseUrl + 'searchRecipes/' + recipeName).subscribe(result => {
  ...
  postRecipe(recipeDetails: Recipe): Promise<boolean> {
    return new Promise((resolve, reject) => {
      ...
      this.authRequest().then(authState => {
        if(authState) {
          this.httpClient.post<{message: string, recipe: any}>(this.baseUrl + 'createRecipe', postData, { withCredentials: true }).subscribe(response => {
  ...
  getUsername(): Promise<string> {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.httpClient.get<{ message: string, username: string, userStatus: string }>(this.authUrl + 'getSessionUsername', { withCredentials: true })
        .subscribe(
          response => {
  ...
  deleteRecipe(recipeId: string) {
    ...
    this.authRequest().then(authState => {
      if(authState) {
        this.httpClient.delete<{message: string}>(this.baseUrl + 'deleteRecipe/' + recipeId, {withCredentials: true}).subscribe(response => {
          this.getRecipeList();
        });
      }
    });
  ...
  saveRecipe(recipeId: string) {
    ...
    this.authRequest().then(authState => {
      if(authState) {
        this.httpClient.post<{message: string}>(this.authUrl + 'saveRecipe', postData, { withCredentials: true }).subscribe(response => {
  ...
  removeSavedRecipe(recipeId: string) {
    ...
    this.authRequest().then(authState => {
      if(authState) {
        this.httpClient.post<{message: string}>(this.authUrl + 'removeSavedRecipe', postData, { withCredentials: true }).subscribe(response => {
  ...
  checkRecipeSavedStatus(recipeId: string): Promise<boolean> {
    return new Promise<boolean>((resolve, reject) => {
      ...
      this.httpClient.post<{message: string}>(this.authUrl + 'checkRecipeSavedStatus', postData, { withCredentials: true }).subscribe(response => {
        resolve(true);
      },
      error => {
        resolve(false);
  ...
  authRequest(): Promise<boolean> {
    return new Promise((resolve, reject) => {
      ...
      this.httpClient.get<{message: string}>(this.authUrl + 'authRequest', { withCredentials: true }).subscribe(response => {
        resolve(true);
      },
      error => {
        console.error('Error occurred during HTTP request:', error);
