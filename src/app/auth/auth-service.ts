...
export class authService {
    ...
    signUp(username: string, password: string) {
      ...
      this.httpClient.post<{ message: string, userStatus: string }>('https://recipemasterapi.duckdns.org/auth/signUp', postData).subscribe(response => {
    ...
    logIn(username: string, password: string) {
      ...
      this.httpClient.post<{message: string, userStatus: string}>('https://recipemasterapi.duckdns.org/auth/logIn', postData, { withCredentials: true }).subscribe(response => {
    ...
    logOut() {
      // { withCredentials: true } is needed for sessions in passport.js to function properky and req.isAuthenticated() to work
      this.httpClient.get<{message: string, userStatus: string}>('https://recipemasterapi.duckdns.org/auth/logOut', { withCredentials: true }).subscribe(response => {
