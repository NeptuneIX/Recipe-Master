...
export class authService {
    ...
    signUp(username: string, password: string) {
      ...
      this.httpClient.post<{ message: string, userStatus: string }>('https://srv-cs837da3esus7386f700-hibernate-6f485bd765-cw578:10000/auth/signUp', postData).subscribe(response => {
    ...
    logIn(username: string, password: string) {
      ...
      this.httpClient.post<{message: string, userStatus: string}>('https://srv-cs837da3esus7386f700-hibernate-6f485bd765-cw578:10000/auth/logIn', postData, { withCredentials: true }).subscribe(response => {
    ...
    logOut() {
      // { withCredentials: true } is needed for sessions in passport.js to function properky and req.isAuthenticated() to work
      this.httpClient.get<{message: string, userStatus: string}>('https://srv-cs837da3esus7386f700-hibernate-6f485bd765-cw578:10000/auth/logOut', { withCredentials: true }).subscribe(response => {
